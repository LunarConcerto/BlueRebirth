...
local HintText = {
  ...
  [2] = {
    "\229\183\178\231\148\179\232\175\183",
    "uipic_ui_settings_im_heidi",
    UIHelper.GetString(210020),
    "#717983"
  },
  ...
  [4] = {
    "\228\186\146\228\184\186\229\165\189\229\143\139",
    "uipic_ui_settings_im_heidi",
    UIHelper.GetString(210020),
    "#FF9C00"
  }
  ...
  UIHelper.CreateSubPart(widgets.obj_member, widgets.trans_member, #self.m_matchPlayerInfoList, function(index, tabPart)
    ...
    if uidInfo == nil then
      ...
      UGUIEventListener.AddButtonOnClick(tabPart.btn_Request, function()
        ...
        elseif frinedState == 4 then
          noticeManager:OpenTipPage(self, "\230\130\168\229\146\140\232\175\165\229\144\141\231\142\169\229\174\182\229\183\178\228\186\146\228\184\186\229\165\189\229\143\139\239\188\140\230\151\160\233\156\128\231\148\179\232\175\183")
        end
      end, self)
