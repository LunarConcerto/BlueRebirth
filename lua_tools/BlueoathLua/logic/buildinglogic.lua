...
function BuildingLogic:GetBuildingRecipes()
  local tabRecipe = configManager.GetData("config_recipe")
  local recipeMap = {}
  ...
  table.sort(recipes, function(l, r)
    local lcfg = configManager.GetDataById("config_recipe", l.recipeIds[1])
    local rcfg = configManager.GetDataById("config_recipe", r.recipeIds[1])
...
function BuildingLogic:CheckProduceItemCost(recipeId, count)
